...
3. 'sub_task_input': Object (the input for the specified tool or action). For "GeminiStepExecutor" by "Orchestrator", if it's the final answer, include 'isFinalAnswer: true'.
...
Example of a plan using ExploreSearchResults and a final GeminiStepExecutor step:
\`\`\`json
[
  [
    {
  ...
  [
    {
      ...
      "sub_task_input": {
        "prompt_template": "Based on the gathered information: {{previous_step_output}}, synthesize a comprehensive and user-facing answer to the original query about server-side rendering. This is the final answer for the user.",
        "isFinalAnswer": true
      },
      "narrative_step": "Synthesize the final, user-facing answer about SSR advantages from the explored content."
    }
  ]
]
\`\`\`
